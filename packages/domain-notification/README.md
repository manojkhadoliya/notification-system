...
**Contains zero imports of Prisma, amqplib, or any provider SDK** — that's
the whole point (see [ADR 0005](../../docs/adr/0005-ddd-hexagonal-architecture.md)).
Testable in isolation with in-memory fake adapters.

**Implemented by:** `infra-postgres`, `infra-rabbitmq`, `providers-sms`,
`providers-push`.
